...
/// <summary>
/// One direction's outcome. Both rates leave out the warm-up. <see cref="PeakBitsPerSecond"/> is the
/// best rate held over the peak window (one second by default), so a single lucky sample cannot
/// inflate it.
/// </summary>
